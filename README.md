...
There are several methods for identifying a suitable resulting model in multiple linear regression. The method proposed by Gimour is demanding, particularly in terms of constructing all possible submodels for all combinations of regressors. The presented software automates this process in the first step, as shown in Figure 1.
